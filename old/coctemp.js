...
async function validateTransfer(){
  ...
  dapp.coc.on("PushBon", () => {
    ...
    if (document.getElementById("mailTransfer").checked == true){
      var fournisseurMail = localStorage.getItem("mail");
      window.location.assign('mailto:' + fournisseurMail + '?subject=' + fournisseurNom + '%20veut%20a%20envoyer%20un%20financement.&body=Rendez-vous%20sur%20http://127.0.0.1:8080/Chain-of-Claims/index.html');
    }else{
      self.close();
    }
  ...
  var fournisseurNom = document.getElementById("fournisseur").innerHTML ;
